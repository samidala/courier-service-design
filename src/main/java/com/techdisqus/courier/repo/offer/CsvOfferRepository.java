...
import com.techdisqus.courier.exceptions.InvalidOfferCriteriaDefinationException;
import com.techdisqus.courier.exceptions.InvalidOfferDefinationException;
import com.techdisqus.courier.model.csv.CsvOffer;
import com.techdisqus.courier.model.csv.CsvOfferCriteria;
import com.techdisqus.courier.domain.offer.Offer;
import com.techdisqus.courier.domain.offer.OfferCriteria;
import com.techdisqus.courier.util.CsvReader;
...
public class CsvOfferRepository {
    ...
    private static final Map<String, OfferCriteria.ValueHandler<Package, String>> valueHandlerMapDef = OfferCriteria.getPackageValueHandlerMap();
